...
// app/Http/Controllers/kasir/StatisticsController.php
...
class KasirStatisticsController extends Controller
{
    public function index()
    {
        ...
        return view('kasir.statistics.index', compact('topProducts', 'totalRevenue', 'totalDiscount'));
    }
