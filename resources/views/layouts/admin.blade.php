...
<head>
  <meta charset="UTF-8">
  <title>POS Admin | Herbal Village</title>
  ...
  <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-2 text-[15px] font-medium">
    ...
    <a href="/admin/produk"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition
              {{ request()->is('admin/produk') ? 'bg-asparagus text-white shadow-md' : 'text-gray-700 hover:bg-asparagus-light hover:text-asparagus' }}">
    ...
    <a href="/admin/users"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition
              {{ request()->is('admin/users') ? 'bg-asparagus text-white shadow-md' : 'text-gray-700 hover:bg-asparagus-light hover:text-asparagus' }}">
    ...
    <a href="/admin/transactions"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition
              {{ request()->is('admin/transactions') ? 'bg-asparagus text-white shadow-md' : 'text-gray-700 hover:bg-asparagus-light hover:text-asparagus' }}">
    ...
    <a href="/admin/statistics"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition
              {{ request()->is('admin/statistics') ? 'bg-asparagus text-white shadow-md' : 'text-gray-700 hover:bg-asparagus-light hover:text-asparagus' }}">
    ...
    <a href="/admin/reports"
       class="flex items-center gap-3 px-4 py-3 rounded-lg transition
              {{ request()->is('admin/reports') ? 'bg-asparagus text-white shadow-md' : 'text-gray-700 hover:bg-asparagus-light hover:text-asparagus' }}">
...
<div class="flex-1 flex flex-col min-h-screen">
  ...
  <header class="bg-white border-b flex items-center justify-between px-4 md:px-8 py-4 shadow-sm relative z-10">
    <div class="flex items-center gap-4">
      ...
      <h1 class="text-xl md:text-2xl font-bold text-asparagus">Admin Herbal Village</h1>
    </div>
